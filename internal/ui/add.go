...
func newAddRuleModel(peers []tailscale.Peer) addRuleModel {
	...
	description.Width = len(description.Placeholder)
...
func (a *addRuleModel) Init() tea.Cmd {
	return a.descriptionInput.Focus()
}
...
func (a *addRuleModel) Update(msg tea.Msg) tea.Cmd {
	...
	switch a.step {
	case 0:
		return a.updateDescription(msg)
	case 1:
...
func (a *addRuleModel) updateDescription(msg tea.Msg) tea.Cmd {
	var cmd tea.Cmd
	a.descriptionInput, cmd = a.descriptionInput.Update(msg)

	if key, ok := msg.(tea.KeyMsg); ok && key.Type == tea.KeyEnter {
		a.description = strings.TrimSpace(a.descriptionInput.Value())
		a.step = 1
		a.errMsg = ""
...
func (a addRuleModel) View() string {
	...
	case 0:
		...
		b.WriteString(a.descriptionInput.View())
	case 1:
